...
import { MixedRouteTrade, MixedRouteSDK } from '@maxosllc/router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2 } from '@maxosllc/v2-sdk'
import {
  Trade as V3Trade,
  Route as V3Route,
  Pool as V3Pool,
...
import { Pool as V4Pool, Route as V4Route, Trade as V4Trade, Position as V4Position } from '@maxosllc/v4-sdk'
